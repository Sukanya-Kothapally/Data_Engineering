...
#After Specifying the Assertions this is the code written to validate
...
print("Number of records which have Distance from Intersection greater than 0 when Road Character is not 1and milepoint is not provided are",count1)#2231
    ...
    if(math.isnan(item[1])):
        ...
        for crash in small['Crash ID']:
            if(math.isnan(crash)):
                ...
                count+=1
print("Number of records which have participant ID for corresponding vehicle ID are",count)#1216b
